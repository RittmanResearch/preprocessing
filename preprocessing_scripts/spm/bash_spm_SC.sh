...
mainDir='/scratch/rb729/SPM_SeedCorrSM8_excluded/'
cd $mainDir
...
for d in PD; do #{Control,PD}; do
	...
	for s in *; do #* ; do
		...
		for cond in * ; do
			...
			template='/scratch/rb729/SPM_SeedCorrSM8/Control/10075/placebo/Template_deob_6.nii' #change this to the new template once you have it
			inflowfield='/scratch/rb729/SPM_SeedCorrSM8_excluded/'${d}'/'${s}'/'${cond}'/u_rc1'${s}'_structural_reordered_deob_Template_deob.nii'
			...
			inepiimage='/scratch/rb729/SPM_SeedCorrSM8_excluded/'${d}'/'${s}'/'${cond}'/'${s}'_functional_reordered_sm_wds.nii.gz'


			instructural='/scratch/rb729/SPM_SeedCorrSM8_excluded/'${d}'/'${s}'/'${cond}'/'${s}'_structural_reordered_deob.nii'
